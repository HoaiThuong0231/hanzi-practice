...
export const RADICALS_214: RadicalInfo[] = [
  ...
  { number: 54, radical: '弄', pinyin: 'nòng', strokes: 3, meaning: 'Củng (chắp tay)', examples: ['弄'] },
  { number: 55, radical: '弋', pinyin: 'yì', strokes: 3, meaning: 'Dặc (bắn tên)', examples: ['式', '弑'] },
...
export const ALL_214_RADICALS: string[] = [
  ...
  '士', '夂', '夕', '大', '女', '子', '宀', '寸', '小', '尢', '尸', '屮', '山', '巛', '工', '己',
  '巾', '干', '幺', '广', '廴', '弄', '弋', '弓', '彐', '彡', '彳', '心', '戈', '戶', '手', '支',
  '攴', '文', '斗', '斤', '方', '无', '日', '曰', '月', '木', '欠', '止', '歹', '殳', '毋', '比',
  '毛', '氏', '气', '水', '火', '爪', '父', '爻', '爿', '片', '牙', '牛', '犬', '玄', '玉', '瓜',
  '瓦', '甘', '生', '用', '田', '疋', '疒', '白', '皮', '皿', '目', '矛', '矢', '石', '示', '禸',
  '禾', '穴', '立', '竹', '米', '糸', '缶', '网', '羊', '羽', '老', '而', '耒', '耳', '聿', '肉',
  '臣', '自', '至', '臼', '舌', '舛', '舟', '艮', '色', '艸', '虍', '虫', '血', '行', '衣', '襾',
  '見', '角', '言', '谷', '豆', '豕', '豸', '貝', '赤', '走', '足', '身', '車', '辛', '辰', '辵',
  '邑', '酉', '采', '里', '金', '長', '門', '隷', '隹', '雨', '靑', '非', '面', '革', '韋', '音',
  '頁', '風', '飛', '食', '首', '香', '馬', '骨', '高', '髟', '鬥', '鬯', '鬲', '鬼', '魚', '鳥',
  '鹵', '鹿', '麥', '麻', '黃', '黍', '黑', '黽', '鼎', '鼓', '鼠', '鼻', '齊', '齒', '龍', '龜', '龠'
];
...
export function getRadicalFullDetail(char: string): string {
  const detailMap: Record<string, { num: number; py: string; hv: string; var?: string; mean: string }> = {
    ...
    '弄': { num: 54, py: 'gǒng', hv: 'Củng', mean: 'chắp tay' },
    '弋': { num: 55, py: 'yì', hv: 'Dặc', mean: 'bắn tên' },
